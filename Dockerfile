FROM pablodelpino/dockedere:latest
...
# endpoints
EXPOSE 80 88 7997 7998 7999 8000 8001 8002 8040 8041 8042 8990 9040 9041 9070 9071

# Define default command (which avoids immediate shutdown)
CMD /opt/MarkLogic/bin/MarkLogic && tail -f /dev/null

# docker run -d --name=dockedere_v3 -p 80:80 -p 88:88 -p 7997:7997 -p 7998:7998 -p 7999:7999 -p 8000:8000 -p 8001:8001 -p 8002:8002
